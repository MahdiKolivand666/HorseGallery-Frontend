...
const WomenLeatherGoldBraceletPage = () => {
  ...
  const allProducts = Array.from({ length: 60 }, (_, i) => {
    ...
    return {
      id: i + 1,
      name: `دستبند چرم و طلا شماره ${i + 1}`,
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-4 sm:px-6 lg:px-8 py-2">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <ChevronLeft className="w-4 h-4 text-primary" />
            <span className="text-primary font-medium">دستبند چرم و طلا</span>
          </nav>
        </div>
      </div>
...
export default WomenLeatherGoldBraceletPage;
